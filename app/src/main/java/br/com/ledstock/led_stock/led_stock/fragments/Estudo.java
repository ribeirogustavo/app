...
import br.com.ledstock.led_stock.led_stock.adapter.EstudosAdapter;
import br.com.ledstock.led_stock.led_stock.domain.LedStockDB;

public class Estudo extends android.support.v4.app.Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().registerReceiver(RefreshEstudos, new IntentFilter("REFRESH_ESTUDOS"));
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        getActivity().unregisterReceiver(RefreshEstudos);
    }
    ...
    private BroadcastReceiver RefreshEstudos = new BroadcastReceiver() {
        @Override
