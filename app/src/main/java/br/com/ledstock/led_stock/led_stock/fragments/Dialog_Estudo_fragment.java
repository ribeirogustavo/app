...
public class Dialog_Estudo_fragment extends DialogFragment {
    ...
    public Dialog_Estudo_fragment() {
        // Required empty public constructor
    }

    public static Dialog_Estudo_fragment newInstance() {
        Dialog_Estudo_fragment fragment = new Dialog_Estudo_fragment();
    ...
    public static void show(FragmentManager fm, long act, long id, Activity context) {
        ...
        Fragment prev = fm.findFragmentByTag("add_estudo_actual");
        ...
        Dialog_Estudo_fragment frag = new Dialog_Estudo_fragment();
        //frag.callback = callback;
        frag.show(ft, "add_estudo_actual");
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_add_estudo, null);
        ...
        */
            ...
            builder.setView(view)
                    ...
                    .setPositiveButton(R.string.salvar, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if ((descricao.getText().toString().trim().length() != 0)
                                ...
                                Toast.makeText(getActivity(), "Estudo criado com Sucesso !", Toast.LENGTH_SHORT).show();
                    ...
                    .setNegativeButton(R.string.cancelar, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            Dialog_Estudo_fragment.this.getDialog().cancel();
                        }
                    });

            builder.setTitle("Inserir Estudo");
            ...
            EditText desc = (EditText) view.findViewById(R.id.nomeestudo);

            AutoCompleteTextView AutoCompletetextView = (AutoCompleteTextView) view.findViewById(R.id.autocompletecliente);
            AutoCompletetextView.setVisibility(View.GONE);

            LedStockDB search_estudo = new LedStockDB(activity);
            Cursor c = search_estudo.SelectEstudoByID(String.valueOf(ID_ESTUDO));
                    ...
                    .setPositiveButton(R.string.salvar, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (descricao.getText().toString().trim().length() != 0) {
                                ...
                                LedStockDB update_estudo = new LedStockDB(activity);
                                update_estudo.Update_Estudo(String.valueOf(ID_ESTUDO), descricao.getText().toString(), "1", null, null, null, null, null, null);
                                LedService updateremote = new LedService();
                                updateremote.UpdateEstudoRemote(ID_ESTUDO);

                                Intent intent_broadcast = new Intent();
                                intent_broadcast.setAction("REFRESH_ESTUDOS");
                                //intent_broadcast.putExtra("ACTION", "EDIT");
                                getActivity().sendBroadcast(intent_broadcast);

                                intent_broadcast.putExtra("nome", descricao.getText().toString());
                                intent_broadcast.setAction("REFRESH_INFOESTUDO");
                                //intent_broadcast.putExtra("ACTION", "EDIT");
                                getActivity().sendBroadcast(intent_broadcast);

                                Toast.makeText(getActivity(), "Estudo Editado com Sucesso !", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(getActivity(), "Os campos não podem ser vazios !", Toast.LENGTH_SHORT).show();
                            }
                        }
            ...
            builder.setTitle("Editar Estudo");
