...
public class Dialog_Pedido_fragment extends DialogFragment {

    private static Activity activity;
    private static String ID_ESTUDO;

    public Dialog_Pedido_fragment() {
        // Required empty public constructor
    }

    public static Dialog_Pedido_fragment newInstance() {
        Dialog_Pedido_fragment fragment = new Dialog_Pedido_fragment();
        Bundle args = new Bundle();
        fragment.setArguments(args);
        return fragment;
    }

    public static void show(FragmentManager fm, String id_estudo ,Activity context) {
        ...
        Dialog_Pedido_fragment frag = new Dialog_Pedido_fragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Cursor pedido = db.SelectEstudoByID(ID_ESTUDO);
                ...
                .setPositiveButton(R.string.salvar, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (radio_pcm.isChecked()) {
                            db.Update_Estudo(ID_ESTUDO, null, "1", null, null, formattedDate, "0", "1", null);
                        } else if (radio_psm.isChecked()) {
                            db.Update_Estudo(ID_ESTUDO, null, "1", null, null, formattedDate, "1", "0", null);
                        } else if (radio_cancel.isChecked()) {
                            db.Update_Estudo(ID_ESTUDO, null, "1", null, null, "", "0", "0", null);
                        }
                        LedService updateremote = new LedService();
                        updateremote.UpdateEstudoRemote(Long.parseLong(ID_ESTUDO));
                    }
                })
