...
public class FragmentEstatisticasEstudo extends android.support.v4.app.Fragment {
    ...
    public FragmentEstatisticasEstudo() {
        // Required empty public constructor
    }

    public static FragmentEstatisticasEstudo newInstance() {
        FragmentEstatisticasEstudo fragment = new FragmentEstatisticasEstudo();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().registerReceiver(RefreshEstatisticasEstudo, new IntentFilter("REFRESH_ESTATISTICAS_ESTUDO"));
    }
    ...
    private BroadcastReceiver RefreshEstatisticasEstudo = new BroadcastReceiver() {
        @Override
    ...
    public void onDestroy() {
        ...
        getActivity().unregisterReceiver(RefreshEstatisticasEstudo);
    }
